...
.sidebar-link.active {
    background: linear-gradient(45deg, #f26f21, #ff8c42);
    color: white;
...
.btn-primary:hover {
    box-shadow: 0 6px 15px rgba(242, 111, 33, 0.4);
...
.btn-success {
    background: linear-gradient(45deg, #2ecc71, #6ee7b7);
    color: white;
...
.btn-danger {
    background: linear-gradient(45deg, #e74c3c, #f87171);
    color: white;
...
.status-badge.status-pending {
    background-color: rgba(243, 156, 18, 0.15); /* Orange/Yellow */
    color: #f39c12;
}
...
.status-badge.status-delivered {
    background-color: rgba(149, 165, 166, 0.15); /* Gray */
    color: #95a5a6;
}

/* Payment Status Badges */
.status-badge.status-payment-paid {
    background-color: rgba(46, 204, 113, 0.15); /* Green */
    color: #2ecc71;
}
.status-badge.status-payment-unpaid,
.status-badge.status-payment-pending {
    background-color: rgba(231, 76, 60, 0.15); /* Red */
    color: #e74c3c;
}
...
.customer-info-section, .order-meta-section {
    flex: 1;
}
.details-section {
    margin-bottom: 25px;
...
.rejection-reason-section .section-title {
    color: #e74c3c;
...
.rejection-reason-section .section-title i {
    color: #e74c3c;
}
...
/* Specific style for the "Change" button */
.btn-image-action.btn-change {
    color: #3498db; /* Blue */
    border-right: 1px solid #eee; /* Separator line */
}

.btn-image-action.btn-change:hover {
